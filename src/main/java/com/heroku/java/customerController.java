...
import com.heroku.java.bean.User;
...
public class customerController {   
    ...
    try {
      ...
      statement1.setString(1, user.getFullname());
    ...
    //   Get id from database for sql 2 from sql 1
      ...
      statement2.setInt(4, customer.getPhonenumC());
      ...
      return "redirect:/";
        ...
        public String updateProfile(HttpSession session, @ModelAttribute("profilecust") Customer customer, Model model, User user) { 
            ...
            int phonenum = customer.getPhonenumC();
